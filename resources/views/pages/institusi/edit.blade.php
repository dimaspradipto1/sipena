...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Checklist Institusi</li>
        </ol>
    </nav>
    <p class="text-muted small">Perbarui profil perguruan tinggi dan Indikator Penilaian SIMKATMAWA.</p>
</div><!-- End Page Title -->
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('kode_pt') is-invalid @enderror" id="kode_pt" name="kode_pt" value="{{ old('kode_pt', $institusi->kode_pt) }}" required placeholder="Contoh: 101015">
                    </div>
                    <div class="col-md-6">
                        <label for="nama_pt" class="form-label fw-medium">Nama Perguruan Tinggi <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('nama_pt') is-invalid @enderror" id="nama_pt" name="nama_pt" value="{{ old('nama_pt', $institusi->nama_pt) }}" required placeholder="Nama Perguruan Tinggi">
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="bentuk_pt" name="bentuk_pt">
                            @foreach($options['bentuks'] as $key => $label)
                                <option value="{{ $key }}" {{ old('bentuk_pt', $institusi->bentuk_pt) == $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="status_institusi" name="status_institusi">
                            @foreach($options['statuses'] as $key => $label)
                                <option value="{{ $key }}" {{ old('status_institusi', $institusi->status_institusi) == $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center px-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm text-center" name="mhs_nonapbn" value="{{ old('mhs_nonapbn', $institusi->mhs_nonapbn ?? 0) }}" min="0">
                                </td>
                                <td class="pe-4">
                                    <input type="url" class="form-control form-control-sm bg-light" name="link_nonapbn" value="{{ old('link_nonapbn', $institusi->link_nonapbn) }}" placeholder="https://...">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center px-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm text-center" name="mhs_aktif" value="{{ old('mhs_aktif', $institusi->mhs_aktif ?? 0) }}" min="0">
                                </td>
                                <td class="pe-4">
                                    <input type="url" class="form-control form-control-sm bg-light" name="link_mhs_aktif" value="{{ old('link_mhs_aktif', $institusi->link_mhs_aktif) }}" placeholder="https://...">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <div class="border rounded-3 p-3 bg-white h-100">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="level_kelembagaan" id="level1" value="Level 1" {{ old('level_kelembagaan', $institusi->level_kelembagaan) == 'Level 1' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="border rounded-3 p-3 bg-white h-100">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="level_kelembagaan" id="level2" value="Level 2" {{ old('level_kelembagaan', $institusi->level_kelembagaan) == 'Level 2' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="border rounded-3 p-3 bg-white h-100">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="level_kelembagaan" id="level3" value="Level 3" {{ old('level_kelembagaan', $institusi->level_kelembagaan ?? 'Level 3') == 'Level 3' ? 'checked' : '' }}>
                    ...
                    <table class="table table-hover align-middle m-0" style="font-size: 0.875rem;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="pe-3">
                                    <input type="url" class="form-control form-control-sm bg-light" name="link_sk_pengangkat_pimpinan" value="{{ old('link_sk_pengangkat_pimpinan', $institusi->link_sk_pengangkat_pimpinan) }}" placeholder="https://...">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="pe-3">
                                    <input type="url" class="form-control form-control-sm bg-light" name="link_struktur_pengelola_kemahasiswaan" value="{{ old('link_struktur_pengelola_kemahasiswaan', $institusi->link_struktur_pengelola_kemahasiswaan) }}" placeholder="https://...">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center px-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm text-center" name="total_anggaran_pt" value="{{ old('total_anggaran_pt', $institusi->total_anggaran_pt ?? 0) }}" min="0" step="1000">
                                </td>
                                <td class="pe-4">
                                    <input type="url" class="form-control form-control-sm bg-light" name="link_anggaran_pt" value="{{ old('link_anggaran_pt', $institusi->link_anggaran_pt) }}" placeholder="https://...">
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4 fw-medium text-secondary">2</td>
                                ...
                                <td class="text-center px-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm text-center" name="total_anggaran_kemahasiswaan" value="{{ old('total_anggaran_kemahasiswaan', $institusi->total_anggaran_kemahasiswaan ?? 0) }}" min="0" step="1000">
                                </td>
                                <td class="pe-4">
                                    <input type="url" class="form-control form-control-sm bg-light" name="link_anggaran_kemahasiswaan" value="{{ old('link_anggaran_kemahasiswaan', $institusi->link_anggaran_kemahasiswaan) }}" placeholder="https://...">
                                </td>
                            </tr>
                        </tbody>
                    </table>
