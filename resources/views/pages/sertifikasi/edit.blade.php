...
<div class="pagetitle">
    ...
    <p class="text-muted small">Perbarui data sertifikasi, mahasiswa, dan dosen pendamping.</p>
</div><!-- End Page Title -->
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('level') is-invalid @enderror" id="level" name="level" required>
                            <option value="" disabled {{ old('level', $sertifikasi->level) ? '' : 'selected' }}>Pilih Level</option>
                            @foreach($options['levels'] as $key => $label)
                                <option value="{{ $key }}" {{ old('level', $sertifikasi->level) == $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_sertifikasi') is-invalid @enderror" id="nama_sertifikasi" name="nama_sertifikasi" value="{{ old('nama_sertifikasi', $sertifikasi->nama_sertifikasi) }}" placeholder="Nama Sertifikasi" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_penyelenggara') is-invalid @enderror" id="nama_penyelenggara" name="nama_penyelenggara" value="{{ old('nama_penyelenggara', $sertifikasi->nama_penyelenggara) }}" placeholder="Penyelenggara" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" class="form-control @error('url_sertifikasi') is-invalid @enderror" id="url_sertifikasi" name="url_sertifikasi" value="{{ old('url_sertifikasi', $sertifikasi->url_sertifikasi) }}" placeholder="URL Sertifikasi">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light text-secondary"><i class="bi bi-link-45deg"></i></span>
                            <input type="url" class="form-control @error('link_dokumen_sertifikat') is-invalid @enderror" id="link_dokumen_sertifikat" name="link_dokumen_sertifikat" value="{{ old('link_dokumen_sertifikat', $sertifikasi->link_dokumen_sertifikat) }}" placeholder="URL Sertifikat">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control @error('tanggal_sertifikat') is-invalid @enderror" id="tanggal_sertifikat" name="tanggal_sertifikat" value="{{ old('tanggal_sertifikat', $sertifikasi->tanggal_sertifikat ? $sertifikasi->tanggal_sertifikat->format('Y-m-d') : '') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light text-secondary"><i class="bi bi-link-45deg"></i></span>
                            <input type="url" class="form-control @error('link_foto_kegiatan') is-invalid @enderror" id="link_foto_kegiatan" name="link_foto_kegiatan" value="{{ old('link_foto_kegiatan', $sertifikasi->link_foto_kegiatan) }}" placeholder="URL Foto Kegiatan">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light text-secondary"><i class="bi bi-link-45deg"></i></span>
                            <input type="url" class="form-control @error('link_dokumen_undangan') is-invalid @enderror" id="link_dokumen_undangan" name="link_dokumen_undangan" value="{{ old('link_dokumen_undangan', $sertifikasi->link_dokumen_undangan) }}" placeholder="URL Dokumen">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" value="{{ old('keterangan', $sertifikasi->keterangan) }}" placeholder="Keterangan tambahan">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body p-4">
                ...
                <div id="container-mahasiswa">
                    @php
                        $mahasiswaList = old('data_mahasiswa', $sertifikasi->data_mahasiswa ?? [['nim' => '', 'nama' => '']]);
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body p-4">
                ...
                <div id="container-dosen">
                    @php
                        $dosenList = old('data_dosen', $sertifikasi->data_dosen ?? [['nidn' => '', 'nama' => '', 'url_surat' => '']]);
                        if (empty($dosenList)) {
