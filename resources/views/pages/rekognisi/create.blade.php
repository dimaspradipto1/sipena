...
<div class="pagetitle">
    ...
    <p class="text-muted small">Lengkapi data rekognisi, mahasiswa, dan dosen pendamping dalam satu alur.</p>
</div><!-- End Page Title -->
...
<section class="section">
    ...
    <form action="{{ route('rekognisi.store') }}" method="POST">
        @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_rekognisi') is-invalid @enderror" id="nama_rekognisi" name="nama_rekognisi" value="{{ old('nama_rekognisi') }}" placeholder="Nama Rekognisi" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_penyelenggara') is-invalid @enderror" id="nama_penyelenggara" name="nama_penyelenggara" value="{{ old('nama_penyelenggara') }}" placeholder="Penyelenggara/Mitra" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" class="form-control @error('url_rekognisi') is-invalid @enderror" id="url_rekognisi" name="url_rekognisi" value="{{ old('url_rekognisi') }}" placeholder="URL Rekognisi">
                        </div>
                    </div>
