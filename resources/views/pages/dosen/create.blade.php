        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 border-0">
                    <h5 class="card-title m-0 p-0 text-dark fw-bold">Form Tambah Data Dosen</h5>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('nidn_nuptk') is-invalid @enderror" id="nidn_nuptk" name="nidn_nuptk" value="{{ old('nidn_nuptk') }}" placeholder="Contoh: 0012058501">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_dosen') is-invalid @enderror" id="nama_dosen" name="nama_dosen" value="{{ old('nama_dosen') }}" placeholder="Contoh: Hendra Wijaya, S.T., M.Eng." required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('program_studi') is-invalid @enderror" id="program_studi" name="program_studi">
                                    ...
                                    @foreach($options['prodis'] as $key => $label)
                                        <option value="{{ $key }}" {{ old('program_studi') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="pt-2">
                                    @foreach($options['statuses'] as $key => $label)
                                        <div class="form-check form-check-inline me-4">
                                            <input class="form-check-input @error('status') is-invalid @enderror" type="radio" name="status" id="status_{{ strtolower($key) }}" value="{{ $key }}" {{ old('status', 'Aktif') == $key ? 'checked' : '' }} required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="contoh: hendra.dosen@uis.ac.id">
                                </div>
                            </div>
